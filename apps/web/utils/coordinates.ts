...
export const isWithin100Meters = (homeCoordinate: LocationWithoutTime, newCoordinate: LocationWithoutTime): boolean => {
  const distance = calculateDistance(homeCoordinate, newCoordinate);

  return distance <= 100;
};

export const calculateDistance = (pointA: LocationWithoutTime, pointB: LocationWithoutTime) => {
